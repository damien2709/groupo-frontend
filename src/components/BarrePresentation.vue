<template>
  <div class="container BarreCategories mt-2">
        <div class="row blockCard">
            ...
            <div class="card col-md-6 col-lg-3 h-25" @click="reqCat('Fun')">
